...
GRATING: # group: 'GRATING' belongs to NXmonochromator group
  ...
  diffraction_order: # field: "diffraction_order" belongs to group "GRATING"
    nxclass: NX_INT
    value: $post-run:grating_diffraction_order
    dtype: int32
  substrate_material: # field: "substrate_material" belongs to group "GRATING"
    nxclass: NX_CHAR
    value: $pre-run-md:grating_substrate_material
    dtype: str
